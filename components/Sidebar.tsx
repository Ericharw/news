              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl font-medium transition-all ${
                  activeMenu === "dashboard"
                    ? "bg-gradient-to-r from-[#0072CE] to-[#00A3E0] text-white font-bold shadow-md shadow-[#0072CE]/20"
                    : "text-slate-600 hover:bg-slate-50 hover:text-slate-900"
                }`}
              >
                <LayoutDashboard className={`w-5 h-5 shrink-0 ${activeMenu === "dashboard" ? "text-white" : "text-[#0072CE]"}`} />
